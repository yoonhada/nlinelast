...
public:
	enum {	MMP_DADDY = 0, MMP_MOM, MMP_SON, MMP_DAUGHTER, MMP_FAMILY_END, 
			MMP_FIRSTAIDKIT_0, MMP_FIRSTAIDKIT_1, MMP_FIRSTAIDKIT_2, MMP_FIRSTAIDKIT_3, MMP_FIRSTAIDKIT_4, MMP_FAK_END, 
			MMP_PANDA, MMP_BEAR, MMP_CROWN, MMP_MONSTER_END,
			MMP_DOOR_0, MMP_DOOR_1, MMP_DOOR_2, MMP_DOOR_END,
			MMP_END };
