...
VOID MainGUI::CreateMiniMap()
{
	...
	m_pGUIBase->AddFileName( 0, imgParamFirstAidKit1, L"Img\\MainScene\\FirstAidKit_0.png", 100 );
	m_pGUIBase->AddFileName( 0, imgParamFirstAidKit1, L"Img\\MainScene\\FirstAidKit_1.png", 100 );
	m_pGUIBase->AddFileName( 0, imgParamFirstAidKit1, L"Img\\MainScene\\FirstAidKit_2.png", 100 );

	m_pMmpObject[ MMP_FIRSTAIDKIT_1 ]->Create( fX, fY, fWidth, fHeight, imgParamFirstAidKit1 );

	GUIBase::IMAGEPARAM imgParamFirstAidKit2;
	m_pGUIBase->AddFileName( 0, imgParamFirstAidKit2, L"Img\\MainScene\\FirstAidKit_0.png", 100 );
	m_pGUIBase->AddFileName( 0, imgParamFirstAidKit2, L"Img\\MainScene\\FirstAidKit_1.png", 100 );
	m_pGUIBase->AddFileName( 0, imgParamFirstAidKit2, L"Img\\MainScene\\FirstAidKit_2.png", 100 );

	m_pMmpObject[ MMP_FIRSTAIDKIT_2 ]->Create( fX, fY, fWidth, fHeight, imgParamFirstAidKit2 );

	GUIBase::IMAGEPARAM imgParamFirstAidKit3;
	m_pGUIBase->AddFileName( 0, imgParamFirstAidKit3, L"Img\\MainScene\\FirstAidKit_0.png", 100 );
	m_pGUIBase->AddFileName( 0, imgParamFirstAidKit3, L"Img\\MainScene\\FirstAidKit_1.png", 100 );
	m_pGUIBase->AddFileName( 0, imgParamFirstAidKit3, L"Img\\MainScene\\FirstAidKit_2.png", 100 );

	m_pMmpObject[ MMP_FIRSTAIDKIT_3 ]->Create( fX, fY, fWidth, fHeight, imgParamFirstAidKit3 );

	GUIBase::IMAGEPARAM imgParamFirstAidKit4;
	m_pGUIBase->AddFileName( 0, imgParamFirstAidKit4, L"Img\\MainScene\\FirstAidKit_0.png", 100 );
	m_pGUIBase->AddFileName( 0, imgParamFirstAidKit4, L"Img\\MainScene\\FirstAidKit_1.png", 100);
	m_pGUIBase->AddFileName( 0, imgParamFirstAidKit4, L"Img\\MainScene\\FirstAidKit_2.png", 100 );
...
VOID MainGUI::Create()
{
	...
	m_pChatEdit->Create(	MAIN_CHAT,
							...
							imgParamEdit,
							imgParamCaret );
	m_pChatEdit->SetFont( MAIN_CHAT, L"휴먼매직체", 20, 20 );
	...
	m_pChatWindow->SetFont( L"휴먼매직체", 20, 20, 0x00000000 );
